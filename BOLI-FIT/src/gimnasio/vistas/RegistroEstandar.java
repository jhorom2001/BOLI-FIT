...
import gimnasio.controlador.AltaAfiliadoEstandarControlador;
import gimnasio.controlador.AltaAfiliadoEstandarControladorInterfaz;
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					AltaAfiliadoEstandarControladorInterfaz controlador=new AltaAfiliadoEstandarControlador();
					...
					double primerPago = Double.parseDouble(textField_6.getText());
					
					double segundoPago = Double.parseDouble(textField_7.getText());
				
					controlador.altaAfiliadoEstandar(dni, nombre, apellido, telefono, correo, direccion, primerPago, segundoPago);
